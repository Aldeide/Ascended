...
- Alternatively, run tests locally via PowerShell using `.\run_tests.ps1` or via Bash using `./run_tests.sh` (see the **Local Testing** section in `README.md` for environment setup and usage instructions).
