...
- Alternatively, run tests locally using `.\run_tests.ps1` (PowerShell) or `./run_tests.sh` (Bash) (see the **Local Testing** section in `README.md` for environment setup and usage instructions).
