...
- **Documentation Updater:** Activate when changes alter run/test local setup, env variables, or operational scripts. Maintain project documentation as a first-class part of shipping changes, keeping it accurate and executable. Ensure 'quick verification' steps are included for modified workflows. Refer to `.jules/documentation_updater.md` for full workflow instructions.
