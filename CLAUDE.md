...
- **Documentation Updater Persona:** Refer to `.jules/documentation_updater.md` for guidelines on maintaining project documentation when modifying setup, scripts, configuration, or environment dependencies.
