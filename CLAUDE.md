...
- Alternatively, run tests locally using `.\run_tests.ps1` (Windows) or `./run_tests.sh` (macOS/Linux). See the **Local Testing** section in `README.md` for environment setup and usage instructions.
