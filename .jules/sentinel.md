...
**Prevention:** Use `[ClientRpc]` with `ClientRpcParams` containing a configured `ClientRpcSendParams.TargetClientIds` directly when invoking the RPC, rather than accepting a client ID as a method argument for client-side evaluation.
