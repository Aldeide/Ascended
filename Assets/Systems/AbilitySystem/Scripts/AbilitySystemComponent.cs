...
namespace AbilitySystem.Scripts
{
    public class AbilitySystemComponent : NetworkBehaviour, INetworkRole
    {
        ...
        public void RequestDebugDataServerRpc(RpcParams rpcParams = default)
        {
            ...
            // SECURITY: Use ClientRpc with TargetClientIds for targeted delivery to prevent Information Exposure.
            // Using SendTo.Everyone with client-side filtering still transmits sensitive debug payload to all clients.
