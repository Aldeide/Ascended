...
namespace AISystem.Runtime.Sensors
{
    public class EnemyTargetSensor : LocalTargetSensorBase
    {
        ...
        public override ITarget Sense(IActionReceiver agent, IComponentReference references, ITarget existingTarget)
        {
            ...
            // Bolt Optimization: Replace expensive GameObject.FindGameObjectsWithTag & Object.FindObjectsOfType
            // with a fast iteration over the cached AbilitySystemRegistry.
