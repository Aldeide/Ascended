...
using NewGraph.Nodes;
using UnityEditor;
using UnityEngine;

namespace NewGraph
{
    public class AbilityGraphModel : ScriptableObject, IGraphModelData {
        [SerializeField, HideInInspector]
        private GraphModelBase baseModel = new GraphModelBase();

        public NodeModel ActivateAbilityNode = new NodeModel(new ActivateAbilityNode());
